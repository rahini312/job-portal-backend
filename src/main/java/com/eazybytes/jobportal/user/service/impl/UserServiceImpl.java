...
public class UserServiceImpl implements IUserService {
    ...
    public JobApplicationDto applyForJob(String userEmail, ApplyJobRequestDto applyJobRequestDto) {
        ...
        //Here we no need to update DB, since job entity is loaded, it will be automatically taken care by hibernate to
        //update in DB
    ...
    public void withdrawApplication(String userEmail, Long jobId) {
        ...
        //Here hard - delete is used. But in real enterprise applications, soft-delete is used. No real deletion happens.
