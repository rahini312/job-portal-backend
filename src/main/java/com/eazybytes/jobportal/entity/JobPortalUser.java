...
public class JobPortalUser extends BaseEntity {
    ...
    //A user will have many saved jobs.
    //A job will be saved by many users. Hence, many to many.
    //We don't need to create third table for this, spring data automatically creates.
    @ManyToMany
