...
public class JobPortalUsernamePwdAuthenticationProvider implements AuthenticationProvider {
    ...
    public @Nullable Authentication authenticate(Authentication authentication) throws AuthenticationException {
        ...
        //SimpleGranted Authority is a class from spring security which stores the roles of the user as a list.
        //Our project has only one role for each user, but enterprise application will have multiple roles for each user.
