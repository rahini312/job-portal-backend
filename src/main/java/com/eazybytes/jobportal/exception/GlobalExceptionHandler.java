...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponseDto> handleException(Exception exception, WebRequest webRequest) {
        ...
        //When anything needs to be fixed, ops team will fetch the traceId from the logs and give to backend dev
        //Backend dev can look in Grafana UI with the traceId
